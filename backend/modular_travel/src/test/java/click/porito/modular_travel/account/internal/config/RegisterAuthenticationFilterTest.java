...
class RegisterAuthenticationFilterTest {
    ...
    @BeforeEach
    void beforeEach(){
        accountService = spy(AccountService.class);
        validator = validatorFactory.getValidator();
        registerFilter = spy(new RegisterAuthenticationFilter(objectMapper, validator, accountService));
    }
    ...
    class attemptAuthentication{
        ...
        void insufficientInfoRequest() throws Exception {
            ...
            AccountRegisterForm onlyName = AccountRegisterForm.builder().name("onlyName").build();
            AccountRegisterForm copy = new AccountRegisterForm(onlyName);//copy
            ...
            AccountRegisterForm insufficientForm = AccountRegisterForm.builder().gender(Account.Gender.MALE).build();
        ...
        void properRequest() throws ServletException, IOException {
            ...
            AccountRegisterForm insufficientForm = AccountRegisterForm.builder()
    ...
    static OidcInsufficientUserInfoException createOidcInsufficientUserInfoException(){
        return new OidcInsufficientUserInfoException(
                ...
                mock(AccountRegisterForm.class),
                mock(Set.class)
        );
    }

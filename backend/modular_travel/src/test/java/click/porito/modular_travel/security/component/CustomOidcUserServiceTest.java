...
class CustomOidcUserServiceTest {
    ...
    void setUp() {
        ...
        customOidcUserService = spy(new CustomOidcUserService(accountApi, validator));
    ...
    class loadUserTest {
        ...
        void existingAccount() {
            ...
            Account account = mock(Account.class);
            when(account.toOidcUser(any())).thenReturn(mock(OidcUser.class));
            when(accountApi.getAccountByEmail(any())).thenReturn(java.util.Optional.of(account));
            ...
            assertNotNull(loaded);
            verify(account, times(1)).toOidcUser(any());
            verify(accountApi, times(1)).getAccountByEmail(any());
        }
    }

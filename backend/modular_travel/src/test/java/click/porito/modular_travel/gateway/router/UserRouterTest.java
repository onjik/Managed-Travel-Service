...
class UserRouterTest {
    ...
    @MockBean
    private AccountInternalApi accountService;
    ...
    class getProfile {
        ...
        public void getProfile() throws Exception {
            ...
            AccountSummaryDTO dto = AccountSummaryDTO.AccountSummaryDTOImpl.builder()
                    ...
                    .profileImgUri("uri")
                    .build();
            when(accountService.getAccountSummaryByUserId(any())).thenReturn(Optional.of(dto));
            //when
        ...
        public void getProfile_notFound() throws Exception {
            //given
            when(accountService.getAccountByUserId(any())).thenThrow(new UserNotFoundException());
            //when
            mvc.perform(get("/users/1/profile").with(oidcLogin().authorities(Role.USER)))
            //then

...
public interface PlaceCommandApi {
     ...
     */
    UserPlaceView putUserPlace(UserPlacePutRequest request);
     ...
     * @throws AccessDeniedException 권한이 없는 경우
     */
    OfficialPlaceView putOfficialPlace(OfficialPlacePutRequest request);
     ...
     * @throws AccessDeniedException 권한이 없는 경우
     */
    OperationTimeView putOperationTime(OperationTimePutRequest request);

...
import click.porito.travel_core.plan.api.reqeust.pointer.StructureAwareDayPointer;
import click.porito.travel_core.plan.api.reqeust.pointer.StructureAwarePointer;
import click.porito.travel_core.plan.api.reqeust.pointer.StructureAwareWaypointPointer;
...
import click.porito.travel_core.plan.operation.adapter.MockPlanOperation;
...
class PlanRouteApiImplTest {
    ...
    void setUp() {
        ...
        planRouteApi = new PlanRouteApiImpl(planOperation);
    }

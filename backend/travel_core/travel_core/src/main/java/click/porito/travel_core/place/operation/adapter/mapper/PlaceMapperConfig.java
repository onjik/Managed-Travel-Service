package click.porito.travel_core.place.operation.adapter.mapper;

import click.porito.travel_core.Mapper;
import click.porito.travel_core.place.operation.adapter.google_api.model.GooglePhotoReference;
import click.porito.travel_core.place.operation.adapter.google_api.model.GooglePlace;
import click.porito.travel_core.place.domain.AuthorAttribution;
import click.porito.travel_core.place.domain.PhotoReference;
import click.porito.travel_core.place.domain.Place;
import click.porito.travel_core.place.operation.adapter.persistence.entity.AuthorAttributionEntity;
import click.porito.travel_core.place.operation.adapter.persistence.entity.PhotoEntity;
